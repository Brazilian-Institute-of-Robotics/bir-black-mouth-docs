...
Baseado nos conceitos apresentados, foi projetado, simulado e desenvolvido um robô quadrúpede nomeado de Caramelo (figuras \ref{fig:terrenos}, \ref{fig:caramel_body} e \ref{fig:moving_body}). Esta plataforma é um robô quadrúpede de pequeno porte voltado para pesquisa e educação. 
...
O subsistema de controle do robô é composto por três elementos principais: o controlador de angulação do corpo do robô, o planejador de trajetória e o modelo cinemático. O controle de angulação do corpo do robô é responsável por controlar o ângulo de \textit{pitch} (rotação em $y$) e o de \textit{roll} (rotação em $x$), de modo a manter o robô em $0^{\circ}$ a todo momento. O planejador de trajetória é o responsável por controlar cada pata do robô e, por consequência, o corpo.  Ele define onde cada pata deve pisar e calcula a trajetória que elas devem realizar, com base nas etapas de \textit{stance} e \textit{swing}, de forma a mover o robô na direção e velocidade desejadas. Os pontos desta trajetória são convertidos nos ângulos de juntas através do modelo cinemático. (Além disso, o planejador de trajetória também considera o esforço de controle enviado pelos controladores de angulação). Por fim, o modelo cinemático do robô é responsável por mapear a posição tridimensional de cada pata e obter a angulação das juntas que a compõe. 
...
A seguir, serão detalhados o modelo cinemático, o controlador de angulação e do planejador trajetória.
